		...
		<div class="row">
			...
			<div class="col-md-4 viewleavebox" align="center" style="margin-top: 30px">
				...
				<div class="form-group" align="left" style="font-size: 1.2em ;margin-top: 5%;">
						<!-- <label for="employeeid">Serial Number</label> --><input type="hidden"
					...
					<div
						...
						<input type="submit" value="Submit" class="btn btn-success" formaction="leave-update.in" />
						<input type="reset" value="clear" class="btn btn-warning" />
						<input type="button" id="viewLeaveBackbtn" value="Go back!" style="padding-bottom: 8px;" onclick="history.go(-2)">
					</div>
				</form>
				</div>
			</div>
