	...
	<div class="container-fluid">
		<div class="row" style="margin-top: 8%">
			...
			<div class="col-md-4 center">
				...
				<c:set var="message" scope="page" value="Successfully LoggedIn"></c:set>
			</div>
			<div class="col-md-4"></div>
		</div>
		<div class="row">
			...
			<div class="col-md-4 size" style="margin-top: 20px">
				<form  method="post" class="side">
					...
					<div class="center form-group">
						<input type="submit" value="Login" formaction="welcome.in" class="btn btn-success">
					
					<input type="submit" value="Home" formaction="*.action" class="btn btn-primary">
					</div>
				</form>
			</div>
			<div class="col-md-4"></div>
