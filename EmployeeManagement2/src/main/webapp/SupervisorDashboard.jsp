...
<body style="background-image: url('images/bgdash1.jpg'); height: 100vh;">
	...
	<div class="container-fluid"  >
		<div class="row" >
			...
			<form method="post">
			<input type="submit" value="Log-out" formaction="login.action" style="background-color: #ffffff;border-radius: 5px;">
			</form>
		...
		<div class="row ">
			...
			<div class="col-md-8 tablecolour" style="margin-top: 50px">
				...
				<input type="submit" value="LEAVE FORMS"
					style="margin-bottom: 68px; margin-left: 91px;"  class="button" formaction="leaveList.in"></input>	
				</form>
			</div>
